...
public class Test {
	...
	private static SaleRequest ticket01 = new SaleRequest(client01, "Finance", vehicle01);
	private static SaleRequest ticket02 = new SaleRequest(client02, "Lease", vehicle02);
	private static SaleRequest ticket03 = new SaleRequest(client02, "Full Sale", vehicle03);
	...
	public static void testSaleRequestObject() {
		System.out.println("Test if each sale request object has a unique id, a type of sale and a vehicle stock number:");
		System.out.println("ticket01 ID: " + ticket01.getTicketID() + " Type of Sale: " + ticket01.getTypeOfSale() + " Vehicle Stock Number: " + ticket01.getVehicle().getStockNumber());
		System.out.println("ticket02 ID: " + ticket02.getTicketID() + " Type of Sale: " + ticket02.getTypeOfSale() + " Vehicle Stock Number: " + ticket02.getVehicle().getStockNumber());
		System.out.println("ticket02 ID: " + ticket03.getTicketID() + " Type of Sale: " + ticket03.getTypeOfSale() + " Vehicle Stock Number: " + ticket03.getVehicle().getStockNumber());
	}
}
